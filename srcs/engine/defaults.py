...
from srcs.evaluation import (ReidEvaluator,
                                 inference_on_dataset, print_csv_format)
from srcs.modeling.meta_arch import build_model
from srcs.solver import build_lr_scheduler, build_optimizer
from srcs.utils import comm
from srcs.utils.checkpoint import Checkpointer
from srcs.utils.collect_env import collect_env_info
from srcs.utils.env import seed_all_rng
from srcs.utils.events import CommonMetricPrinter, JSONWriter, TensorboardXWriter
from srcs.utils.file_io import PathManager
...
def default_argument_parser():
    """
    Create a parser with some common arguments used by srcs users.
    Returns:
        argparse.ArgumentParser:
    """
    parser = argparse.ArgumentParser(description="srcs Training")
...
class DefaultTrainer(TrainerBase):
    ...
    It is only guaranteed to work well with the standard models and training workflow in srcs.
    ...
    def __init__(self, cfg):
        ...
        """
        super().__init__()
        logger = logging.getLogger("srcs")
        if not logger.isEnabledFor(logging.INFO):  # setup_logger is not called for srcs
            setup_logger()
    ...
    def build_model(cls, cfg):
        ...
        Returns:
            torch.nn.Module:
        It now calls :func:`srcs.modeling.build_model`.
    ...
    def build_optimizer(cls, cfg, model):
        ...
        It now calls :func:`srcs.solver.build_optimizer`.
    ...
    def build_lr_scheduler(cls, cfg, optimizer, iters_per_epoch):
        """
        It now calls :func:`srcs.solver.build_lr_scheduler`.
    ...
    def build_train_loader(cls, cfg):
        ...
        Returns:
            iterable
        It now calls :func:`srcs.data.build_reid_train_loader`.
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        Returns:
            iterable
        It now calls :func:`srcs.data.build_reid_test_loader`.
        Overwrite it if you'd like a different data loader.
        """
