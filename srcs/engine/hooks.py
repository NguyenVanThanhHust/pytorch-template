...
from srcs.evaluation.testing import flatten_results_dict
from srcs.solver import optim
from srcs.utils import comm
from srcs.utils.checkpoint import PeriodicCheckpointer as _PeriodicCheckpointer
from srcs.utils.events import EventStorage, EventWriter, get_event_storage
from srcs.utils.file_io import PathManager
from srcs.utils.precision_bn import update_bn_stats, get_bn_modules
from srcs.utils.timer import Timer
...
class PeriodicCheckpointer(_PeriodicCheckpointer, HookBase):
    """
    Same as :class:`srcs.utils.checkpoint.PeriodicCheckpointer`, but as a hook.
...
class AutogradProfiler(HookBase):
    ...
    def after_step(self):
        ...
        if "://" not in out_file:
            ...
            with tempfile.TemporaryDirectory(prefix="srcs_profiler") as d:
